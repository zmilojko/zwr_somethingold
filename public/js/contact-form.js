			...
			success: function(){
				...
				$('#contact_form').html("<div class='download-box'>Contact form submitted!</div>")
					...
					.fadeIn(1500, function(){
						$('#contact_form').append("<br><br><a id='back' onclick='window.location.reload(); return false;' class='link10'>back<img src='images/link1-marker.png' alt='' class='img-pad1'></a>");
						Cufon.refresh();
					});
			}
		});				
